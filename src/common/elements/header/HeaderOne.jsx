...
const HeaderOne = ({ pClass, darkLogo, lightLogo, postData, meta }) => {
  ...
  const metaData = {
    favicon: {
      width: meta.attributes.favicon.data.attributes.width,
      height: meta.attributes.favicon.data.attributes.height,
      img: getStrapiMedia(meta.attributes.favicon),
      alt: meta.attributes.favicon.data.attributes.alternativeText,
    },
  };
  return (
    <>
